...
credit to https://github.com/duanyifei/configparser
...
class RawConfigParser(MutableMapping):
    ...
    def _write_section(self, fp, section_name, section_items, delimiter):
        ...
        comment_line = self.comment_line_dict.get("%s" % (section_name), [])
        if comment_line:
            fp.write("\n".join(comment_line) + "\n")
        fp.write("[{}]\n".format(section_name))
        for key, value in section_items:
            ...
            if value is not None or not self._allow_no_value:
                ...
                value = ""
            comment_line = self.comment_line_dict.get("%s.%s" % (section_name, key), [])
            if comment_line:
                fp.write("\n".join(comment_line) + "\n")
            fp.write("{}{}\n".format(key, value))
        fp.write("\n")
            ...
            # a section header or option header?
                ...
                # an option line?
                    ...
                    if mo:
                        ...
                        self.comment_line_dict["%s.%s" % (sectname, optname)] = self.delete_blank_line(
                            comment_line_cache)
                        comment_line_cache = []
                        if (self._strict and
